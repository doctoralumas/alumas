...
const must=['scripts/schema-check.mjs','scripts/db-smoke.mjs','scripts/create-baseline-migration.mjs','tests/contracts/security-contracts.test.mjs','tests/smoke/project-smoke.test.mjs','docs/V28_BUILD_AND_TEST.md','prisma/migrations/README.md'];
