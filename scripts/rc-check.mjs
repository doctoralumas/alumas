...
const required=["proxy.ts","lib/release-config.ts","app/maintenance/page.tsx","app/api/version/route.ts","app/api/app-config/route.ts","docs/RELEASE_CHECKLIST.md","docs/RELEASE_PROMOTION.md"];
