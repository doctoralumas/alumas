...
const ORG_TYPES:any = {HOSPITAL: "Hastane", CLINIC: "Klinik", PHARMACY: "Eczane", IMAGING_CENTER: "Görüntüleme Merkezi", LABORATORY: "Tıbbi Laboratuvar"};
...
{o.type === 'IMAGING_CENTER' && (
  <div className="metric" style={{background: '#f0f9ff', border: '1px solid #e0f2fe', borderRadius: '12px', padding: '16px', color: '#0f172a'}}>
    <span style={{color: '#0284c7', fontSize: '0.85rem', fontWeight: 600, textTransform: 'uppercase'}}>Tetkik kataloğu</span>
    <strong style={{fontSize: '2rem', color: '#0369a1'}}>{o.imagingExams?.length||0}</strong>
    <small style={{color: '#0284c7'}}>yayındaki tetkik</small>
  </div>
)}

{o.type === 'LABORATORY' && (
  <div className="metric" style={{background: '#f0fdfa', border: '1px solid #ccfbf1', borderRadius: '12px', padding: '16px', color: '#0f172a'}}>
    <span style={{color: '#0f766e', fontSize: '0.85rem', fontWeight: 600, textTransform: 'uppercase'}}>Tahlil kataloğu</span>
    <strong style={{fontSize: '2rem', color: '#115e59'}}>{o.laboratoryTests?.length||0}</strong>
    <small style={{color: '#0f766e'}}>yayındaki tahlil</small>
  </div>
)}
